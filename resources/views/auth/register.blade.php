...
<body>
    ...
    <form class="form" enctype="multipart/form-data" style="margin : auto ;width: 450px; padding-top: 200px" method="post" action="{{ url('register')}}">
        ...
        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="is_user" name="is_user" checked>
            <label class="form-check-label" for="is_user">User</label>
        </div>

        <div class="form-check">
            <input type="checkbox" class="form-check-input" id="is_admin" name="is_admin">
            <label class="form-check-label" for="is_user">Admin</label>
        </div>
...
<!-- Mirrored from jiade.dexignlab.com/xhtml/page-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Feb 2024 05:23:33 GMT -->
                    ...
                    <div class="row no-gutters">
                        <div class="col-xl-12 tab-content">
                            <div id="sign-up" class="auth-form tab-pane fade show active  form-validation">
                                <form class="form" enctype="multipart/form-data" method="post" action="{{ url('register')}}">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-xl-6 col-12">
                                            <a href="javascript:void(0);" class="btn btn-outline-dark btn-block btn-sm mt-xl-0 mt-3">
                                                <svg class="me-1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 456.008 560.035">
                                    ...
                                    <div class="form-row d-flex justify-content-between mt-4 mb-2">
                                        <div class="mb-3">
                                            <div class="form-check custom-checkbox mb-0">
                                                <input type="checkbox" class="form-check-input" id="is_admin" name="is_admin" required="">
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check custom-checkbox mb-0">
                                                <input type="checkbox" class="form-check-input" name="is_user" checked id="is_user" required="">
                                                <label class="form-check-label" for="is_user">User</label>
                                            </div>
                                        </div>
