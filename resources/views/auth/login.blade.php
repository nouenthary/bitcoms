...
<body>
    ...
    <form class="" style="margin : auto ;width: 450px; padding-top: 200px" method="post" action="{{ url('login-post')}}">
        ...
        <a href="{{url('register_page')}}" class="btn btn-danger btn-block">
            Register
        </a>
    </form>
</body>
...
<!-- Mirrored from jiade.dexignlab.com/xhtml/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Feb 2024 05:22:09 GMT -->
                        ...
                        <div class="col-xl-12 tab-content">
                            <div id="sign-up" class="auth-form tab-pane fade show active  form-validation">
                                ...
                                <div class="new-account mt-3 text-center">
                                    <p class="font-w500">Already have an account? <a class="text-primary" href="{{url('register_page')}}">Sign in</a></p>
                                </div>
                            </div>
...
<!-- Mirrored from jiade.dexignlab.com/xhtml/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Feb 2024 05:22:12 GMT -->
