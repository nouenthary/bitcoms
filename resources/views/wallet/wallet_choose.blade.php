    ...
    <div class="card">
        ...
        <div class="card-header border-0 pb-0 d-block">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    <h3 class="card-title">Name Wallets</h3>
                    <span>You have <strong class="text-primary">list</strong> wallets</span>
                </div>
                <div class="icon-box icon-box-sm bg-dark">
        ...
        <div class="card-body pt-4 pb-0 height300 dlab-scroll">

            <div style="display: none;">
                <div class="d-flex justify-content-between my-2a border-bottom-dashed p-2 card-wallet">
                    <div class="d-flex align-items-center">
                        <img src="images/profile/small/pic4.jpg" alt="" class="avatar w-image">
                        <div class="ms-3">
                            <h5 class="mb-1"><a class="w-currency text-uppercase">Samanta William</a></h5>
                            <span class="fs-14 text-muted w-name">Marketing Manager</span>
                        </div>
                    </div>
