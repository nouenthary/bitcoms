...
<!-- Mirrored from jiade.dexignlab.com/xhtml/page-error-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Feb 2024 05:23:33 GMT -->
                ...
                <div class="col-md-6">
                    <div class="error-page">
                        <div class="error-inner text-center">
                            ...
                            <a href="{{url()->previous()}}" class="btn btn-secondary">BACK TO HOMEPAGE</a>
                        </div>
                    </div>
                </div>
            </div>
